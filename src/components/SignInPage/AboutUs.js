...
<div className="slide-container">
        ...
        <div class="card">
          ...
          <div class="container">
            ...
            <p>I'm Electrical Engineer, I've got my degree from JUST. I have four years of experince in Industrial Automation feild. Github account</p>
          </div>
        </div>
        <div class="card">
        ...
        <div class="card">
          ...
          <div class="container">
            ...
            <p>
              Mechanical Engineer fresh graduate from Jordan University of Since
              and Technology
            </p>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="container">
            ...
            <p>A Software engineering fresh graduate from the hashemite University.</p>
          </div>
        </div>
        </Slide>
